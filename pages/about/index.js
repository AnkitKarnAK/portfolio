        ...
        <div className="flex-1 flex h-full flex-col justify-around gap-6">
          ...
          >
            ...
            {skills.map((skill, index) => (
              <div key={index} className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
                <div className="flex-1 flex max-w-max gap-x-2 items-center text-white/60">
                  ...
                  {skill.icons.map((icon, index) => (
                    <div key={index} className="flex flex-col items-center gap-4 w-[30px] sm:w-[100px]">
                      {/* icons */}
                      <div className="text-2xl text-white peer">{icon.icon}</div>
                      <span className="hidden sm:block peer-hover:block">{icon.name}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="flex flex-1 xl:gap-x-6">
              ...
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  <CountUp start={0} end={2} duration={5} delay={2} /> +
                </div>
